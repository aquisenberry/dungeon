...
var splatSystemRequire = require.context(
  "splat-ecs/lib/systems",
  true,
  /\.js$/
);
...
var localDataRequire = require.context("./data", true, /\.js(on)?$/);
// console.log(localDataRequire);
...
function customRequire(path) {
  ...
  if (path.indexOf(localDataPath) === 0) {
    var dataName = "./" + path.substr(localDataPath.length + 1) + "/index.js";
    return localDataRequire(dataName).default;
  }
